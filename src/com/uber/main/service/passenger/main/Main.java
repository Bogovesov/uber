...
import com.uber.main.service.passenger.profile.Email;
import com.uber.main.service.passenger.profile.Gender;
import com.uber.main.service.passenger.profile.Name;
import com.uber.main.service.passenger.profile.PhoneNumber;
import com.uber.main.service.passenger.requirements.CarType;
...
public class Main {
    public static void main(String[] args) {
        ...
        Requirements requirements = new Requirements(CarType.BUSINESS);
        Route route = new Route("From work to home", work, home);
        passenger.addNewOrder(route, requirements);
    }
}
